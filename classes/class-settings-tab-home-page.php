 ...
 * @package lonewolf
 */
class Settings_Tab_Home_Page {

	public const PAGE  = 'lw_page_dev_landing';
	public const GROUP = 'lw_group_dev_landing';
	...
	public function init() {
		...
		$this->settings = get_option( 'lw_home_landing_settings' );

		register_setting(
			self::GROUP,
			'lw_home_landing_settings',
			array( $this, 'sanitize' )
		);
	...
	public function welcome_title_callback() {
		printf(
			'<input class="regular-text" type="text" name="lw_home_landing_settings[welcome_title]" id="welcome_title" value="%s">',
	...
	public function welcome_intro_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[welcome_intro]" id="welcome_intro" cols="50" rows="6">%s</textarea>',
	...
	public function welcome_cta_title_callback() {
		printf(
			'<input class="regular-text" type="text" name="lw_home_landing_settings[welcome_cta_title]" id="welcome_cta_title" value="%s">',
	...
	public function welcome_cta_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[welcome_cta_text]" id="welcome_cta_text" cols="50" rows="6">%s</textarea>',
	...
	public function services_title_callback() {
		printf(
			'<input class="regular-text" type="text" name="lw_home_landing_settings[services_title]" id="services_title" value="%s">',
	...
	public function services_intro_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[services_intro]" id="services_intro" cols="50" rows="6">%s</textarea>',
	...
	public function service1_bullets_callback() {
		printf(
			'<textarea class="narrow-text" type="text" name="lw_home_landing_settings[service1_bullets]" id="service1_bullets" cols="30" rows="8">%s</textarea>',
	...
	public function service1_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[service1_text]" id="service1_text" cols="50" rows="6">%s</textarea>',
	...
	public function service2_bullets_callback() {
		printf(
			'<textarea class="narrow-text" type="text" name="lw_home_landing_settings[service2_bullets]" id="service2_bullets" cols="30" rows="8">%s</textarea>',
	...
	public function service2_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[service2_text]" id="service2_text" cols="50" rows="6">%s</textarea>',
	...
	public function service3_bullets_callback() {
		printf(
			'<textarea class="narrow-text" type="text" name="lw_home_landing_settings[service3_bullets]" id="service3_bullets" cols="30" rows="8">%s</textarea>',
	...
	public function service3_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[service3_text]" id="service3_text" cols="50" rows="6">%s</textarea>',
	...
	public function service4_bullets_callback() {
		printf(
			'<textarea class="narrow-text" type="text" name="lw_home_landing_settings[service4_bullets]" id="service4_bullets" cols="30" rows="8">%s</textarea>',
	...
	public function service4_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[service4_text]" id="service4_text" cols="50" rows="6">%s</textarea>',
	...
	public function usp_title_callback() {
		printf(
			'<input class="regular-text" type="text" name="lw_home_landing_settings[usp_title]" id="usp_title" value="%s">',
	...
	public function usp_intro_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[usp_intro]" id="usp_intro" cols="50" rows="6">%s</textarea>',
	...
	public function usp1_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[usp1_text]" id="usp1_text" cols="50" rows="6">%s</textarea>',
	...
	public function usp2_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[usp2_text]" id="usp2_text" cols="50" rows="6">%s</textarea>',
	...
	public function usp3_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[usp3_text]" id="usp3_text" cols="50" rows="6">%s</textarea>',
	...
	public function usp4_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[usp4_text]" id="usp4_text" cols="50" rows="6">%s</textarea>',
	...
	public function usp5_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[usp5_text]" id="usp5_text" cols="50" rows="6">%s</textarea>',
	...
	public function usp6_text_callback() {
		printf(
			'<textarea class="regular-text" type="text" name="lw_home_landing_settings[usp6_text]" id="usp6_text" cols="50" rows="6">%s</textarea>',
