 ...
 * Slug: lonewolf/call-to-action-2
 * Categories: lonewolf
...
<div class="wp-block-button is-style-primary is-style-fill"><a class="wp-block-button__link wp-element-button">' . esc_html__( 'Learn More', 'lonewolf' ) . '</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
