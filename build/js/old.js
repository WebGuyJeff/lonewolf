...
/***/ "./src/js/old/_css-animator-old.js":
/*!*****************************************!*\
  !*** ./src/js/old/_css-animator-old.js ***!
  \*****************************************/
...
/* harmony export */ });
/**
 * OLD BUNDLE!!! CSS Animation Module.
 */
...
/***/ "./src/js/old/_dropdown-control-old.js":
/*!*********************************************!*\
  !*** ./src/js/old/_dropdown-control-old.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   dropdownControlOld: () => (/* binding */ dropdownControlOld)
/* harmony export */ });
/**
 * OLD BUNDLE!!! Dropdown Menu Javascript
 */
...
const dropdownControlOld = {
  ...
  initDropdowns: function () {
    ...
    document.addEventListener('click', dropdownControlOld.pageClickHandler);
    ...
    [...hoverDropdowns].forEach(dropdown => {
      dropdownControlOld.registerHover(dropdown);
    });

    // Attach 'click' event handler to the menu container(s).
    menuContainers.forEach(menu => {
      menu.addEventListener('click', dropdownControlOld.menuClickHandler);
  ...
  initialise: () => {
    let docLoaded = setInterval(function () {
      if (document.readyState === 'complete') {
        ...
        dropdownControlOld.initDropdowns();
      }
    }, 100);
  },
  /**
  ...
  pageClickHandler: function (event) {
    ...
    [...activeDropdowns].forEach(dropdown => {
      ...
      dropdownControlOld.close(dropdown.querySelector('.dropdown_toggle'));
    });
  },
  /**
   * Hover Event Handler.
  ...
  hoverHandler: function (event) {
    ...
    if (event.type === 'mouseenter') {
      // Open it.
      dropdownControlOld.open(button);
      ...
      if (!!button.closest('[data-hover-lock="true"]') === false && button.classList.contains('dropdown_toggle-active')) {
        ...
        setTimeout(() => {
          if (!button.parentElement.contains(hoverTarget)) {
            dropdownControlOld.close(button);
          }
    ...
    if (event.type === 'focusin') {
      ...
      if (!!button.closest('[data-hover-lock="true"]') === false && button.classList.contains('dropdown_toggle-active')) {
        ...
        if (!!event.target.closest('.dropdown-hover').contains(event.relatedTarget) === false) {
          ...
          dropdownControlOld.close(event.target.closest('.dropdown-hover').querySelector('.dropdown_toggle'));
        } else {
          // Close dropdown.
          dropdownControlOld.close(button);
        }
  ...
  registerHover: function (dropdown) {
    ...
    if (!!dropdown.closest('.fullscreenMenu') === false) {
      dropdown.addEventListener('mouseenter', dropdownControlOld.hoverHandler);
      dropdown.addEventListener('mouseleave', dropdownControlOld.hoverHandler);
      dropdown.setAttribute('data-hover-listener', 'true');
    }
    // Attach focus listeners to all menus.
    dropdown.addEventListener('focusin', dropdownControlOld.focusHandler);
    dropdown.addEventListener('focusout', dropdownControlOld.focusHandler);
  },
  /**
  ...
  deregisterHover: function (dropdown) {
    dropdown.removeEventListener('mouseenter', dropdownControlOld.hoverHandler);
    dropdown.removeEventListener('mouseleave', dropdownControlOld.hoverHandler);
  ...
  open: function (button) {
    ...
    if (dropdown.classList.contains('dropdown-hover')) {
      if (dropdownControlOld.isInLeftHalf(dropdown)) {
    ...
    [...activeButtons].forEach(activeButton => {
      ...
      if (!activeButton.parentElement.contains(button)) {
        // Close.
        dropdownControlOld.close(activeButton);
      }
    });
    ...
    [...activeTopLevelDropdowns].forEach(activeDropdown => {
      ...
      if (!activeDropdown.contains(dropdown)) {
        ...
        dropdownControlOld.close(activeDropdown.querySelector('.dropdown_toggle'));
      }
    });
    ...
    dropdownControlOld.scrollIntoView(menu);
  },
  /**
   * Close the menu.
   *
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   heroPunchOld: () => (/* binding */ heroPunchOld)
/* harmony export */ });
/**
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   hideHeaderOld: () => (/* binding */ hideHeaderOld)
/* harmony export */ });
/**
 * OLD BUNDLE!!! Hide-Header
 */

const hideHeaderOld = () => {
  let body = document.querySelector('body');
  let header = document.querySelector('header.pageGrid');
...
/***/ "./src/js/old/_mobile-popup-menu-old.js":
/*!**********************************************!*\
  !*** ./src/js/old/_mobile-popup-menu-old.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   mobilePopupMenuOld: () => (/* binding */ mobilePopupMenuOld)
/* harmony export */ });
/**
 * OLD BUNDLE!!!
 */

const mobilePopupMenuOld = () => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   modalOld: () => (/* binding */ modalOld)
/* harmony export */ });
/* harmony import */ var _css_animator_old__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_css-animator-old */ "./src/js/old/_css-animator-old.js");
/**
 * OLD BUNDLE!!! Modal Javascript
 */
  ...
  async function openModal() {
    if (!active && !animating) {
      ...
      if (mobile) {
        ...
        overlay.style.display = 'contents';
        overlay.style.opacity = '1';
        await (0,_css_animator_old__WEBPACK_IMPORTED_MODULE_0__.animate)(dialog, 'left', 'easeInOutCirc', -768, 0, 800);
        animating = false;
      } else {
        dialog.style.left = '0';
        dialog.style.transform = 'scale(0)';
        ...
        overlay.style.opacity = '0';
        fadeIn(overlay);
        await (0,_css_animator_old__WEBPACK_IMPORTED_MODULE_0__.animate)(dialog, 'scale', 'easeInOutCirc', 0, 1, 800);
        animating = false;
      }
    }
  }
  ...
  async function closeModal() {
    if (active && !animating) {
      ...
      if (mobile) {
        ...
        overlay.style.display = 'contents';
        overlay.style.opacity = '1';
        await (0,_css_animator_old__WEBPACK_IMPORTED_MODULE_0__.animate)(dialog, 'left', 'easeInOutCirc', 0, -768, 800);
        animating = false;
      } else {
        dialog.style.left = '0';
        dialog.style.transform = 'scale(1)';
        ...
        overlay.style.opacity = '1';
        fadeOut(overlay);
        await (0,_css_animator_old__WEBPACK_IMPORTED_MODULE_0__.animate)(dialog, 'scale', 'easeInOutCirc', 1, 0, 800);
        overlay.style.display = 'none';
        animating = false;
      }
    }
...
/***/ "./src/js/old/_screenclass-old.js":
/*!****************************************!*\
  !*** ./src/js/old/_screenclass-old.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   screenClassOld: () => (/* binding */ screenClassOld)
/* harmony export */ });
/**
 * OLD BUNDLE!!! Dynamic Classes Javascript
 */

const screenClassOld = () => {
  ...
  const resizeObserver = new ResizeObserver(entries => set_scrollbar_css_custom_property());
...
/***/ "./src/js/old/_usp-section-old.js":
/*!****************************************!*\
  !*** ./src/js/old/_usp-section-old.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   uspSectionOld: () => (/* binding */ uspSectionOld)
/* harmony export */ });
/**
...
/*!***********************!*\
  ...
  \***********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _old_dropdown_control_old__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./old/_dropdown-control-old */ "./src/js/old/_dropdown-control-old.js");
/* harmony import */ var _old_hideheader_old__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./old/_hideheader-old */ "./src/js/old/_hideheader-old.js");
/* harmony import */ var _old_mobile_popup_menu_old__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./old/_mobile-popup-menu-old */ "./src/js/old/_mobile-popup-menu-old.js");
/* harmony import */ var _old_modal_old__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./old/_modal-old */ "./src/js/old/_modal-old.js");
/* harmony import */ var _old_hero_punch_old__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./old/_hero-punch-old */ "./src/js/old/_hero-punch-old.js");
/* harmony import */ var _old_screenclass_old__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./old/_screenclass-old */ "./src/js/old/_screenclass-old.js");
/* harmony import */ var _old_usp_section_old__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./old/_usp-section-old */ "./src/js/old/_usp-section-old.js");
/**
 * OLD entry point.
 *
 * DO NOT PULL INTO MAIN PRODUCTION!
 * 
...
_old_dropdown_control_old__WEBPACK_IMPORTED_MODULE_0__.dropdownControlOld.initialise();
(0,_old_hideheader_old__WEBPACK_IMPORTED_MODULE_1__.hideHeaderOld)();
(0,_old_mobile_popup_menu_old__WEBPACK_IMPORTED_MODULE_2__.mobilePopupMenuOld)();
(0,_old_modal_old__WEBPACK_IMPORTED_MODULE_3__.modalOld)();
(0,_old_screenclass_old__WEBPACK_IMPORTED_MODULE_5__.screenClassOld)();
(0,_old_usp_section_old__WEBPACK_IMPORTED_MODULE_6__.uspSectionOld)();
(0,_old_hero_punch_old__WEBPACK_IMPORTED_MODULE_4__.heroPunchOld)();
})();
