...
const hideHeader = () => {
   ...
   */
  const show = () => {
    visibilityToPromise(header, 'visible').then(() => transitionToPromise(header, 'transform', 'none')).then(() => isAnimating = false);
  };
  const hide = () => {
...
/* harmony import */ var _frontend_reveal_animation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./frontend/_reveal-animation */ "./src/js/frontend/_reveal-animation.js");
/**
 * Webpack entry point.
 */
...
(0,_frontend_reveal_animation__WEBPACK_IMPORTED_MODULE_5__.revealAnimation)();
})();
