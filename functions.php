<?php
/**
 * Lonewolf Theme Functions.php config file.
 *
 * @package lonewolf
 ...
 */
use BigupWeb\Lonewolf\Settings_Admin;
use BigupWeb\Lonewolf\Register_Projects_CPT;
if ( is_admin() ) {
	new Settings_Admin();
}
 ...
 */
function lw_remove_gutenburg_css() {
 ...
 */
function lonewolf_widgets_init() {
	register_sidebar(
		array(
...
add_action( 'widgets_init', 'lonewolf_widgets_init' );


if ( ! function_exists( 'lonewolf_setup' ) ) :
	/**
...
add_action( 'after_setup_theme', 'lonewolf_setup' );
